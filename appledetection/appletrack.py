...
def detect_apple_in_image(image_path):
    # Load image
    ...
    # Display apple count on the image (optional)
    cv2.putText(image, f'Apples: {apple_count}', (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 3, cv2.LINE_AA)

    # Return the processed image and apple count
    return image, apple_count
